...
\subsection{Institutional Risk Management Frameworks}

Process-oriented governance standards address AI risk through taxonomic categorization and lifecycle processes. The NIST AI Risk Management Framework \citep{nist2023rmf} organizes the process into four functions (Govern, Map, Measure, Manage), while its generative AI companion profile (NIST AI 600-1) enumerates twelve risk categories, including CBRN information, confabulation, information security, and harmful bias, with suggested actions for each. ISO/IEC 42001 \citep{iso42001} is the first internationally certifiable AI management system standard, requiring organizations to conduct AI-specific risk assessments and impact evaluations across 38 controls, though it leaves the choice of risk categories to the implementing organization. The European Union's (EU) General-Purpose AI Code of Practice \citep{gpai-code-2025} establishes a voluntary compliance pathway under the EU AI Act. Its Safety and Security chapter, applicable to providers of general-purpose AI models with systemic risk, mandates assessment of four specified risk types---CBRN, cyber offence, loss of control, and harmful manipulation---plus any additional model-specific systemic risks. These frameworks define the organizational processes through which risk is identified, assessed, and mitigated, but they do not prescribe how the assessment itself should be conducted, nor how risks in one category interact with or amplify risks in another. Our work operates at that lower level of abstraction, where we propose a concrete methodology for the risk assessment step that these frameworks require, while accounting for cross-domain interaction.

\subsection{Model Developer Frontier Safety Policies}

The current generation of frontier AI safety policies includes Anthropic's Responsible Scaling Policy (RSP) \citep{anthropic2024rsp}, OpenAI's Preparedness Framework \citep{openai2023preparedness}, and Google DeepMind's Frontier Safety Framework \citep{deepmind2024fsf}, among others.

These frameworks share a common structural property with the governance standards discussed above: they assess each risk category through its own pipeline without modeling interactions between categories. The RSP evaluates cyber, CBRN, and autonomy risks through separate assessment tracks. The Preparedness Framework produces independent scores per axis. The Frontier Safety Framework specifies critical capability levels domain by domain. This is precisely the gap our work addresses: to our knowledge, none of them provides a mechanism for representing how outcomes in one risk domain may propagate to or compound outcomes in another.
...
\bibitem[General-Purpose AI Code of Practice(2025)]{gpai-code-2025}
European Commission.
\textit{The General-Purpose AI Code of Practice}.
July 10, 2025.
Available at \url{https://digital-strategy.ec.europa.eu/en/policies/contents-code-gpai}
...
\bibitem[ISO/IEC 42001(2023)]{iso42001}
ISO/IEC.
\textit{ISO/IEC 42001:2023 --- Information technology --- Artificial intelligence --- Management system}. 
2023.
Available at \url{https://www.iso.org/standard/81230.html}
...
\textit{Artificial Intelligence Risk Management Framework} (NIST AI 100-1).
January 26, 2023.
\url{https://doi.org/10.6028/NIST.AI.100-1}.

\bibitem[NIST(2024)]{nist2024ai600}
National Institute of Standards and Technology.
